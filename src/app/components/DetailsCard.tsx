...
export default function DetailsCard({ finished, children }: DetailsCardProps) {
  return (
    <div className="flex flex-col gap-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg p-4 sm:p-6 md:p-10 flex-1 w-full transition-colors">
      ...
      <hr className="border-gray-300 dark:border-slate-600 my-3 sm:my-5" />
